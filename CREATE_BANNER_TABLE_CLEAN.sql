-- Clean version for re-running SQL script
...
-- Create trigger function - safe to run multiple times
...
-- Success message
SELECT 'Banner content table and policies created/updated successfully!' as result;
