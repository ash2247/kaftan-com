-- Deploy Safari and Paradise Products to Live Database (FINAL VERSION)
-- Uses the exact status values: 'Active', 'Draft', 'Archived'
...
-- Step 4: Insert Safari Products with 'Active' status
...
-- Step 5: Insert Paradise Products with 'Active' status
INSERT INTO products (
    id, name, slug, price, category, style, color, display_page, status, in_stock, images, created_at
) 
SELECT 
