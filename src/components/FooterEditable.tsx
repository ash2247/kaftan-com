        ...
        <div className="max-w-md mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-0">
            <input
              ...
              className="flex-1 px-4 py-3 bg-background/10 border border-primary-foreground/20 rounded-none text-primary-foreground placeholder-primary-foreground/40 focus:outline-none focus:border-primary-foreground/40 transition-colors"
            />
            <button className="px-6 py-3 bg-primary text-primary-foreground font-body text-xs tracking-[0.2em] uppercase hover:bg-primary/90 transition-colors">
              {ctaText}
            </button>
          </div>
        </div>
